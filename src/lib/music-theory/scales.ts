 ...
 * Includes all standard Push 3 scales.
 */
export const SCALES: Record<string, ScaleDefinition> = {
  ...
  halfWholeDim:     { name: 'Half-Whole Dim',     intervals: [0, 1, 3, 4, 6, 7, 9, 10] },
  wholeHalfDim:     { name: 'Whole-Half Dim',     intervals: [0, 2, 3, 5, 6, 8, 9, 11] },
  superLocrian:     { name: 'Super Locrian',      intervals: [0, 1, 3, 4, 6, 8, 10] },
  hirajoshi:        { name: 'Hirajoshi',          intervals: [0, 2, 3, 7, 8] },
  inSen:            { name: 'In-Sen',             intervals: [0, 1, 5, 7, 10] },
